const DYDX_STRATEGY_ABI = [
  {
    inputs: [
      { internalType: "address", name: "dydxToken", type: "address" },
      { internalType: "address", name: "stakedDydxToken", type: "address" },
      {
        internalType: "address",
        name: "wrappedEthereumDydxToken",
        type: "address",
      },
    ],
  ...
  {
    inputs: [],
    name: "WRAPPED_ETHEREUM_DYDX_TOKEN",
    outputs: [{ internalType: "address", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
...
export default DYDX_STRATEGY_ABI;
